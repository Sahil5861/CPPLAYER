...
use App\Http\Controllers\AppDomainContentController;
...
use App\Http\Controllers\ContentNetworkManageSlider;
use App\Http\Controllers\ManageLanguage;
use App\Http\Controllers\LanuguageSlider;
...
use App\Http\Controllers\ManageRetailers;
use App\Http\Controllers\ResellerPlanController;
use App\Http\Controllers\RetailorPlanController;

use App\Http\Controllers\ResellerWallets;
use App\Http\Controllers\RetailorWallets;
...
use App\Http\Controllers\CDNSettings;
use App\Http\Controllers\ResellerAd;
use App\Http\Controllers\RetailorAd;
...
Route::get('env-test', function () {
    ...
    //     'my_value'   => config('app.my_value'), // jo aapne add kiya
    // ];
...
Route::group(['namespace' => 'App\Http\Controllers'], function()
{
    ...
    Route::group(['middleware' => ['auth', 'check.freeze']], function() {
        ...
        Route::get('/reseller-signin/{id}', [ManageAdmin::class,'resellerLogin'])->name('reseller-signin');
        Route::get('/back-to-admin/{id}', [ManageAdmin::class,'superAdminLogin'])->name('back-to-admin');

        Route::post('/admin-revert-amount/{id}', [ManageAdmin::class,'revertAmount'])->name('admin.revert-amount');

        
       
        // App Domain Content Routes
        Route::get('/app-domain/{admin_id?}', [AppDomainContentController::class, 'index'])->name('app.domain.index');
        Route::post('/app-domain/store', [AppDomainContentController::class, 'store'])->name('admin.domain.store');
        Route::post('/app-domain/update/{id}', [AppDomainContentController::class, 'update'])->name('app.domain.update');

        // Route::get('/app-domain', [AppDomainContentController::class, 'index'])->name('admin.domain.index');            
        // Route::post('/app-domain', [AppDomainContentController::class, 'store'])->name('admin.domain.store');          
        // Route::get('/app-domain/edit/{id}', [AppDomainContentController::class, 'edit'])->name('admin.domain.edit');   
        // Route::post('/app-domain/update/{id}', [AppDomainContentController::class, 'update'])->name('admin.domain.update'); 
        ...
        // Route::get('/get_users', [ManageUser::class, 'get_index'])->name('user.users');
        ...
        Route::get('recent-watch-list', [ManageUser::class,'recentWatchList'])->name('recent-watch-list');
        Route::get('getrecentWatchList', [ManageUser::class,'getrecentWatchList'])->name('getrecentWatchList');
        ...
        Route::post('/reseller-revert-amount/{id}', [ManageReseller::class,'revertAmount'])->name('reseller.revert-amount');



        //Retailers
        Route::get('/retailers', [ManageRetailers::class, 'index'])->name('admin.retailers');
        Route::get('/getRetailorsList', [ManageRetailers::class, 'getRetailorsList'])->name('getRetailorsList');
        Route::post('/getRetailorsListByAdmin', [ManageRetailers::class, 'getRetailorsListByAdmin'])->name('getRetailorsListByAdmin');
        Route::get('/add-retailer', [ManageRetailers::class,'addRetailor'])->name('addRetailor');
        Route::post('/addRetailor', [ManageRetailers::class,'add'])->name('saveRetailor');

        Route::get('/edit-retailer/{id}', [ManageRetailers::class,'editRetailor'])->name('edit-retailer');
        Route::post('/retailor/destroy', [ManageRetailers::class,'destroy'])->name('retailer.destroy');
        Route::get('/retailer/update-status/{id}', [ManageRetailers::class,'updateStatus'])->name('retailer.update-status');

        Route::post('/retailer-revert-amount/{id}', [ManageRetailers::class,'revertAmount'])->name('retailer.revert-amount');
        ...
        Route::get('/tv-show-episode-download-sample-csv', [ManageTvShowEpisode::class, 'downloadSampleCsv'])->name('admin.tv-show-episode.download.sample.csv');
        Route::post('import-csv-tv-show-episode', [ManageTvShowEpisode::class, 'importCsv'])->name('import.csv.tv-show-episode');
        ...
        Route::get('/slider/update-status/{id}', [ManageSlider::class,'updateStatus'])->name('slider.update-status');
        ...
        Route::get('/edit-language/{id}', [ManageLanguage::class,'editLanguage'])->name('edit-language');
        Route::post('/language/destroy', [ManageLanguage::class,'destroy'])->name('language.destroy');

        Route::get('/language-sliders/{id}', [LanuguageSlider::class, 'index'])->name('admin.sliders.language');
        Route::get('/getLanguageSliderList', [LanuguageSlider::class, 'getSliderList'])->name('getSliderList.language');
        Route::get('/add-language-slider/{id}', [LanuguageSlider::class,'addSlider'])->name('addSlider.language');
        Route::post('/addLanguageSlider', [LanuguageSlider::class,'add'])->name('saveSlider.language');
        Route::get('/edit-language-slider/{id}', [LanuguageSlider::class,'editSlider'])->name('edit-slider.language');

        Route::post('/language-slider/destroy', [LanuguageSlider::class,'destroy'])->name('slider.destroy.language');
        Route::get('/language-slider/update-status/{id}', [LanuguageSlider::class,'updateStatus'])->name('update-status.language');
        ...
        Route::get('/channel-order-list', [Channels::class, 'getOrderedList'])->name('getChannelOrderList');
        ...
        Route::get('download-sample-csv', [Channels::class, 'downloadSampleCsv'])->name('download.sample.csv');
        Route::post('import-csv', [Channels::class, 'importCsv'])->name('import.csv');
        ...
        Route::post('swapChannelNumber', [Channels::class, 'swapChannelNumber'])->name('swapChannelNumber');
        ...
        Route::get('/movie/update-recent/{id}', [Movies::class,'updateRecent'])->name('movie.update-recent');
    
        Route::post('import-movies-playlits', [Movies::class, 'importmovies'])->name('importmovies');

        Route::get('/movie-download-sample-csv', [Movies::class, 'downloadSampleCsv'])->name('admin.movie.download.sample.csv');
        Route::post('import-csv-movies', [Movies::class, 'importCsv'])->name('import.csv.movies');

        Route::post('multi-delete', [Movies::class, 'deleteMulti'])->name('delete-multi');
        Route::post('update-multi-status', [Movies::class, 'updateMulti'])->name('update-multi-status');
        ...
        Route::get('/getDeletedChannelList', [StageShowsPak::class, 'getDeletedChannelList'])->name('getDeletedChannelList');
        Route::get('/recover-channel/{id}', [StageShowsPak::class, 'recoverChannel'])->name('admin.stageshow.recoverChannel');
        ...
        Route::get('/getDeletedChannelList', [LaughterShows::class, 'getDeletedChannelList'])->name('getDeletedLaughterShows');
        Route::get('/recover-channel/{id}', [LaughterShows::class, 'recoverChannel'])->name('admin.laughtershow.recoverLaughtershows');
        ...
        // Route::middleware(['adultmovies.email'])->group(function (){
            ...
            Route::get('/adult-movie-download-sample-csv', [AdultMovies::class, 'downloadSampleCsv'])->name('admin.adultmovie.download.sample.csv');
            Route::post('import-csv-adult-movies', [AdultMovies::class, 'importCsv'])->name('import.csv.adult-movies');
        ...
        Route::get('/edit-webseries/{id}', [Webserieses::class,'edit'])->name('edit-webseries');
        Route::get('/webseries-slider/{id}', [Webserieses::class,'sliders'])->name('webseries-slider');
        Route::get('/add-webseries-network-slider/{id}', [Webserieses::class,'addslider'])->name('add-webseries-network-slider');
        Route::get('/edit-webseries-slider/{id}', [Webserieses::class,'editSlider'])->name('edit-slider.webseries');
        Route::get('/getWebseriesSliderList', [Webserieses::class, 'getSliderList'])->name('getWebseriesSliderList');
        Route::post('/addWebseriersSlider', [Webserieses::class,'add'])->name('saveSlider.websereis');
        Route::post('/webseries-slider/destroy', [Webserieses::class,'destroySlider'])->name('slider.destroy.webseries');
        Route::get('/websereis-slider/update-status/{id}', [Webserieses::class,'updateSliderStatus'])->name('update-status.webseries-slider');
        ...
        Route::get('/web-seies/update-status/{id}', [Webserieses::class,'updateStatus'])->name('webseries.update-status');        
        ...
        Route::get('/web-episodes-download-sample-csv', [WebseriesEpisodes::class, 'downloadSampleCsv'])->name('admin.webEpisodes.download.sample.csv');
        Route::post('import-csv-webseries-episodes', [WebseriesEpisodes::class, 'importCsv'])->name('import-csv-webseries-episodes');
        ...
        Route::get('/content-network-order', [ContentNetworks::class, 'orderList'])->name('admin.contentnetwork.orderlist');
        Route::post('/content-network-order-save', [ContentNetworks::class, 'saveOrder'])->name('saveNetworkOrder');


        Route::get('/content-network-sliders/{id}', [ContentNetworkManageSlider::class, 'index'])->name('admin.sliders.contentNetwork');
        Route::get('/getContentNetworkSliderList', [ContentNetworkManageSlider::class, 'getSliderList'])->name('getSliderList.contentNetwork');
        Route::get('/add-content-network-slider/{id}', [ContentNetworkManageSlider::class,'addSlider'])->name('addSlider.contentNetwork');
        Route::post('/addContentNetworkSlider', [ContentNetworkManageSlider::class,'add'])->name('saveSlider.contentNetwork');

        Route::get('/edit-content-network-slider/{id}', [ContentNetworkManageSlider::class,'editSlider'])->name('edit-slider.contentNetwork');
        Route::post('/content-network-slider/destroy', [ContentNetworkManageSlider::class,'destroy'])->name('slider.destroy.contentNetwork');

        Route::get('/content-network-slider/update-status/{id}', [ContentNetworkManageSlider::class,'updateStatus'])->name('update-status.contentNetwork-slider');


        // Route::get('/get-channel-by-id', [ContentNetworkManageSlider::class,'getChannelById'])->name('get-channel-by-id');
        // Route::get('/get-series-by-id', [ContentNetworkManageSlider::class,'getSeriesById'])->name('get-sereis-by-id');
        // Route::get('/get-movie-by-id', [ContentNetworkManageSlider::class,'getMovieById'])->name('get-movie-by-id');
        ...
        Route::get('/add-admin-plan', [AdminPlans::class,'addAdminPlan'])->name('addAdminPlgetTouranamentSeasonsEventsan');
        ...
        Route::post('update-user-freeze-satus/{id}', [ManageUser::class, 'updateUserFreezeStatus'])->name('update-user-freeze-satus');
        ...
        Route::get('/edit-resellerWallet/{id}', [ResellerWallets::class,'editAdminWallet'])->name('edit-resellerWallet');
        Route::post('/resellerWallet/destroy', [ResellerWallets::class,'destroy'])->name('resellerWallet.destroy');
        Route::get('/resellerWallet/update-status/{id}', [ResellerWallets::class,'updateStatus'])->name('resellerWallet.update-status');


        //ResellerWallets
        Route::get('/retailor-wallets', [RetailorWallets::class, 'index'])->name('retailor.resellerWallet');
        Route::get('/get-retailor-wallet-list', [RetailorWallets::class, 'getRetailorWalletList'])->name('getRetailorWalletList');
        Route::get('/add-retailor-wallet', [RetailorWallets::class,'addRetailorWallet'])->name('addRetailorWallet');
        Route::post('/saveRetailorWallet', [RetailorWallets::class,'add'])->name('saveRetailorWallet');

        Route::post('/retailorWallet/destroy', [RetailorWallets::class,'destroy'])->name('retailorWallet.destroy');
        Route::get('/retailorWallet/update-status/{id}', [RetailorWallets::class,'updateStatus'])->name('retailorWallet.update-status');
        ...
        //Retailor Plan
        Route::get('/retailor-plans', [RetailorPlanController::class, 'index'])->name('retailor.retailorPlans');
        Route::get('/get-retailor-plan-list', [RetailorPlanController::class, 'getRetailorPlanList'])->name('getRetailorPlanList');
        Route::get('/add-retailor-plan', [RetailorPlanController::class,'addRetailorPlan'])->name('addRetailorPlan');
        Route::get('/edit-retailorPlan/{id}', [RetailorPlanController::class,'editRetailorPlan'])->name('edit-retailorPlan');
        Route::post('/addRetailorPlan', [RetailorPlanController::class,'add'])->name('saveRetailorPlan');
        Route::get('/retailorPlan/update-status/{id}', [RetailorPlanController::class,'updateStatus'])->name('retailorPlan.update-status');
        Route::post('/get-reseller-plan-price', [RetailorPlanController::class,'getPrice'])->name('get-reseller-plan-price');
        Route::post('/get-reseller-plan-details', [RetailorPlanController::class,'getPlanDetails'])->name('get-reseller-plan-details');
        Route::post('/retailorPlan/destroy', [RetailorPlanController::class,'destroy'])->name('retailorPlan.destroy');
        Route::post('/check-max-selling-price-for-retailor', [RetailorPlanController::class,'checkMaxSellingPriceForRetailor'])->name('check-max-selling-price-for-retailor');
        Route::post('/get-channels-of-plan-retailor', [RetailorPlanController::class,'checkChannelsOfPlan'])->name('get-channels-of-plan-retailor');
        ...
        // Retailors ads 
        Route::get('/retailor-ads', [RetailorAd::class, 'index'])->name('admin.retailor.ads');
        Route::get('/getRetailorAdsList', [RetailorAd::class, 'getRetailorAdsList'])->name('getRetailorAdsList');
        Route::get('/retailor-ads-add', [RetailorAd::class, 'create'])->name('retailor.ad.add');
        Route::get('/retailor-ads-edit/{id}', [RetailorAd::class, 'edit'])->name('retailor.ads.edit');
        Route::post('/retailor-ads-save', [RetailorAd::class, 'save'])->name('retailor.ads.save');
        Route::post('/retailor-ads-remove', [RetailorAd::class, 'destroy'])->name('retailor.ads.remove');
        Route::get('/retailor-ads-update-status/{id}', [RetailorAd::class, 'updateStatus'])->name('retailor.ads.update_status');
        Route::get('/get-ad-details-for-retailor', [RetailorAd::class, 'getAdDetails'])->name('get-ad-details-for-retailor');


        Route::get('url-settings', [SettingsController::class, 'index'])->name('url-settings');
        Route::get('url-settings-list', [SettingsController::class, 'getList'])->name('url-settings-list');
        Route::get('url-settings-add', [SettingsController::class, 'add'])->name('url-settings-add');
        Route::post('url-settings-save', [SettingsController::class, 'save'])->name('url-settings-save');
        Route::post('url-settings-channels-save', [SettingsController::class, 'saveChannel'])->name('url-settings-channels-save');
        ...
        Route::get('/cdn-settings-domain-remove', [CDNSettings::class, 'removeDomain'])->name('cdn-settings.demoins.remove');
