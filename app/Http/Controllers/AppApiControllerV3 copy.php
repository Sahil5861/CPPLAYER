...
class AppApiControllerV3 extends Controller
{
    ...
    public function getNetworks(Request $request)
    {
        ...
        $movie_networks = $series_networks = $tv_shows_networks = $tv_shows_pak_networks =
     ...
     */
    public function signM3U8Url($url, $expirySeconds = 3600)
    {
        // Parse URL
    ...
    public function tokenizeUrl(Request $request)
    {
        ...
        try {
            // Generate signed URL
            $signedUrl = $this->signM3U8Url($request->url);
