...
@section('mytitle', 'Manage Retailer')
@if(isset($user))
@section('page', 'Retailer / Update')
@endif
@if(!isset($user))
@section('page', 'Retailer / Add')
@endif
@section('content')
    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                @endif
                <!-- <div class="row"> -->
                    <form id="user-form"  method="post" action="{{route('saveRetailor')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                        @csrf
