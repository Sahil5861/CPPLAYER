...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
            <div class="widget widget-chart-two">
                <div class="widget-heading">
                    <h5 class="">{{(\Auth::user()->role == 1) ? 'Admin/ Reseller/ Retailor/ User' : ((\Auth::user()->role == 2) ? 'Reseller/ User' : ((\Auth::user()->role == 3) ? 'Retailor/ User' : 'User'))}}</h5>
                </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6 layout-spacing">
            <div class="widget widget-card widget-chart-two">
                <div class="widget-heading widget-heading-card">
                    <h2>{!! config('app.currency_icon') !!}</h2>
                </div>
                <div class="widget-content widget-content-card">
                    <h3>{{$wallet ? $wallet : 0}} <br><span>Wallet Credits</span></h3>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @if($recently_purchase_plan)
                            ...
                            <tr>
                                ...
                                <td><div class="td-content product-brand">Credits @if(isset($row->total_price)){{$row->total_price}}@endif</div></td>
...
var options = {
    ...
    colors: ['#5c1ac3', '#e2a03f', '#36cfc9','#e7515a'],
    dataLabels: {
      enabled: false
    },
    legend: {
    ...
    series: [<?= $total_admin; ?>, <?= $total_reseller; ?>, <?= $total_retailer; ?>, <?= $total_user; ?>],
    labels: ['Admin', 'Reseller', 'Retailer', 'User'],
    responsive: [{
        breakpoint: 1599,
        options: {
            chart: {
