...
@section('mytitle', 'Retailer Packages List')
@section('page', 'Retailer Packages  /  List')
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="text-right">
                    <a href="{{url('add-retailor-plan')}}" class="btn btn-primary mb-2">Add +</a>
                </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#multi-column-ordering').DataTable({
         processing: true,
         serverSide: true,
         ajax: "{{route('getRetailorPlanList')}}",
         columns: [
            { data: 'title' },
            { data: 'price' },
            // { data: 'plan_logo' },
