                    ...
                    <form id="user-form" method="post" action="{{route('savelaughtershow')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="source_type" id="source_type" class="form-control" onchange="toggleBackupUrl(this)">
                                    <option value="M3u8" @if(isset($laughter_show) && $laughter_show->source_type == 'M3u8'){{'selected'}} @endif>M3u8</option>
                                    <option value="MKV" @if(isset($laughter_show) && $laughter_show->source_type == 'MKV'){{'selected'}} @endif>MKV</option>
                            ...
                            <div class="col-md-6 mb-4" id="bkUrldiv" style=" display: {{isset($laughter_show) && $laughter_show->source_type != 'M3u8' ? 'none' : 'block' }}">
                                <label for="trailer">Backup Url</label>
                                <input type="text" name="bk_url" id="bk_url" class="form-control" value="{{old('trailer', isset($laughter_show) ? $laughter_show->backup_url : '')}}" placeholder="Backup Url">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="hidden_countries[]" id="hidden_countries" multiple class="form-control select">                                     
                                <?php
                            ...
                            <div class="invalid-feedback">
                                @error('hidden_countries') {{ $message }} @enderror
                            </div>                                
                        </div>
