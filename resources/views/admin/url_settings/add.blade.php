    ...
    <div class="row layout-top-spacing">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="content_network">Network*</label>    
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="content_type" id="content_type" class="form-control select" required>
                                    ...
                                    {{-- <option value="3" {{ ($url_setting->content_type ?? '') == '3' ? 'selected' : '' }}>Live Channels</option> --}}
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                <form  method="post" action="{{ url('url-settings-channels-save') }}" enctype="multipart/form-data">
                    @csrf
                    @if (isset($url_setting))                        
                        <input type="hidden" name="id" value="{{isset($url_setting) ? $url_setting->id : ''}}">
                    @endif
