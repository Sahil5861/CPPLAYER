        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                @if(session()->has('message'))
                  ...
                  @endif
                <!-- <div class="row"> -->
                    <form id="user-form"  method="post" action="{{route('saveSlider.websereis')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                        @csrf
                        ...
                        <input type="hidden" name="webseries_id" id="webseries_id" value="@if(isset($slider)){{$slider->webseries_id}} @else{{$id}}@endif">
                        <div class="form-row">                            
