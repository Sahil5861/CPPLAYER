                ...
                <!-- <div class="row"> -->
                    <form id="user-form"  method="post" action="{{route('saveSadminWallet')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                        ...
                        <div class="form-row">
                            ...
                            {{-- <div class="col-md-6 mb-4">
                                <label for="fullName">{{env('CREDITS_TEXT')}}*</label>
                                <input type="text" class="form-control" id="amount" name="amount" placeholder="{{env('CREDITS_TEXT')}}" value="{{old('amount')}}@if(isset($wallet)){{$wallet->amount}}@endif" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-4">
                                <label for="fullName">{{env('CREDITS_TEXT')}} Recieve Method (Eg: Cash/WU)*</label>
                                <input type="text" class="form-control" id="amount_method" name="amount_method" placeholder="{{env('CREDITS_TEXT')}} recieve method" value="{{old('amount_method')}}@if(isset($wallet)){{$wallet->amount_method}}@endif" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-4">
                                <label for="fullName">Credits*</label>
                                <input type="text" class="form-control" id="amount" name="amount" placeholder="Credits" value="{{old('amount')}}@if(isset($wallet)){{$wallet->amount}}@endif" required>
                                <div class="invalid-feedback">
                                    @error('amount') {{ $message }} @enderror
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <label for="fullName">Credits Recieve Method (Eg: Cash/WU)*</label>
                                <input type="text" class="form-control" id="amount_method" name="amount_method" placeholder="Credits recieve method" value="{{old('amount_method')}}@if(isset($wallet)){{$wallet->amount_method}}@endif" required>
                                <div class="invalid-feedback">
                                    @error('amount_method') {{ $message }} @enderror
                                </div>
                            </div>
