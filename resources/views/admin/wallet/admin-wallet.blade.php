        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="text-right">
                    {{-- <a href="{{route('addResellerWallet')}}" class="btn btn-primary mb-2">Add {{env('CREDITS_TEXT')}} +</a> --}}
                    <a href="{{route('addResellerWallet')}}" class="btn btn-primary mb-2">Add Credits +</a>
                </div>
