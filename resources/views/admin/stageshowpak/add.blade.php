                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="source_type" id="source_type" class="form-control" onchange="toggleBackupUrl(this)">
                                    ...
                                    <option value="MKV" @if(isset($stage_show) && $stage_show->source_type == 'MKV') {{'selected'}} @endif>MKV</option>
                            ...
                            <div class="col-md-6 mb-4" id="bkUrldiv" style=" display: {{isset($stage_show) && $stage_show->source_type != 'M3u8' ? 'none' : 'block' }}">
                                <label for="trailer">Backup Url</label>
                                <input type="text" name="bk_url" id="bk_url" class="form-control" value="{{old('trailer', isset($stage_show) ? $stage_show->backup_url : '')}}" placeholder="Backup Url">
                                <div class="invalid-feedback">
