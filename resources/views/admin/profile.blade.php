    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                @endif
                <!-- <div class="row"> -->
                    <form id="user-form" method="post" action="{{route('updateProfile')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                        @csrf
                        ...
                        @if (Auth::User()->role == 2)                            
                        <hr>
                        <h4>Update App Domain Content</h4>
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="domain">Domain</label>
                                <input type="text" name="domain" class="form-control" value="{{ old('domain', $edit->domain ?? '') }}" readonly>
                            </div>
