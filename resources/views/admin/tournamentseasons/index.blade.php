                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="text-left">
                        <p>
                            ...
                            <a
                                href="{{ route('admin.sporttournament', base64_encode($sport->id)) }}">{{ strtoupper($sport->title) }}</a>&nbsp;
                            &gt;
                            <a
                                href="{{ route('admin.sporttournamentseasons', base64_encode($tournament->id)) }}">{{ strtoupper($tournament->title) }}</a>&nbsp;
                            &gt;
                        </p>
                    </div>
                    ...
                    <div class="text-right">
                        <a href="{{ route('admin.tournamentseason.order', base64_encode($id)) }}"
                            class="btn btn-primary mb-2">Order Seasons</a>
                        <a href="{{ route('addsportstournamentseason', base64_encode($id)) }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#multi-column-ordering').DataTable({
                ...
                ajax: {
                    url: "{{ route('getsportstournamentseasonList', $id) }}",
                    data: function(d) {
