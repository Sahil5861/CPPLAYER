            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="row d-flex justify-content-start align-items-center">
                        <div class="col-md-3">
                            <select name="select_playlist_id" id="select_playlist_id" class="form-control w-25 select"
                                style="width: 25%;">
                    ...
                    <div class="text-left" style="margin:10px 0; padding-top:20px;">
                        <p>
                            ...
                            <a
                                href="{{ route('admin.webseries.seasons', base64_encode($webseries->id)) }}">{{ strtoupper($webseries->name) }}</a>&nbsp;
                            &gt;
                            <a
                                href="{{ route('admin.webseries.seasons.episodes', base64_encode($season->id)) }}">{{ strtoupper($season->Session_Name) }}</a>
                        </p>
                    </div>
                    <div class="text-right">
                        <a href="{{ url('webseriesepisodes-order/' . base64_encode($id)) }}"
                            class="btn btn-primary mb-2">Order Episodes</a>
                        <a href="{{ url('add-web-series-season-episode/' . base64_encode($id)) }}"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-4 p-3"
                                            ...
                                            <a href="{{ url('web-episodes-download-sample-csv') }}"
                                        ...
                                        <div>
                                            <form id="importCsvForm" enctype="multipart/form-data">
                                                ...
                                                <input type="text" name="season_id" value="{{ $season->id }}">
                    ...
                    <div class="modal fade" id="addContentModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="importmoviesForm" method="POST"
                                        action="{{ route('importPlaylistsereis') }}">
                                        @csrf
                                        <input type="hidden" name="seadon_id" id="seadson_id_playlist"
                                            value="{{ $season->id }}">
                                        <div class="form-group">
                                            <label for="networkName">Playlits Id</label>
                                            <input type="text" class="form-control" name="playlist_id"
                                                id="playlist_id" required placeholder="Enter Playlist Id">
                                        </div>
                                        <div class="form-group">
...
@section('footer')
            ...
            if (target.classList.contains('editable')) {
                ...
                input.addEventListener('keydown', function(e) {
                    if (e.key === 'Enter') {
                        ...
                        const table = document.getElementById('multi-column-ordering').getAttribute(
                            'data-table');
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success) {
                                    const capitalizedColumn = column.charAt(0).toUpperCase() +
                                        column.slice(1);
                                    $('.success-message').html(
                                        `${capitalizedColumn} updated successfully !`);
                                    $('#alert-success').show();
                                    setTimeout(() => {
                                        $('#alert-success').hide();
                                    }, 2000);
    ...
    <script>
        ...
        document.getElementById('importCsvBtn').addEventListener('click', function() {
            ...
            $.ajax({
                url: "{{ url('import-csv-webseries-episodes') }}",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
