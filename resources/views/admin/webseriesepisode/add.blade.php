                ...
                <!-- <div class="row"> -->                    
                    <form id="user-form"  method="post" action="{{route('saveWebseriesEpisode')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="source" id="source" class="form-control select" onchange="toggleBackupUrl(this)">
                                    <option value="m3u8" @if(isset($movieLink) && $movieLink->source == 'm3u8'){{'selected'}} @endif>M3U8</option>
                                     <option value="MKV" @if(isset($movieLink) && $movieLink->source == 'MKV') selected @endif>MKV</option>
                            ...
                            <div class="col-md-6 mb-4" id="bkUrldiv" style=" display: {{isset($episode) && $episode->source != 'm3u8' ? 'none' : 'block' }}">
                                <label for="trailer">Backup Url</label>
                                <input type="text" name="bk_url" id="bk_url" class="form-control" value="{{old('trailer', isset($episode) ? $episode->backup_url : '')}}" placeholder="Backup Url">
                                <div class="invalid-feedback">
