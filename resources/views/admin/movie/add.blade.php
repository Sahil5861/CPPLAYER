...
@section('content')
        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <form id="user-form" method="post" action="{{ route('saveMovie') }}" enctype="multipart/form-data"
                        novalidate class="simple-example">
                        @csrf
                        <input type="hidden" name="id"
                            value="@if (isset($movie)) {{ $movie->id }} @endif">
                        <input type="hidden" name="channel_logo_old"
                            value="@if (isset($channel)) {{ $channel->channel_logo }} @endif">
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control" id="name" onkeyup="channel(this.value)"
                                    name="name" placeholder="Movie Name"
                                    value="{{ old('name') }}@if (isset($movie)) {{ $movie->name }} @endif"
                                    required>
                                <div class="invalid-feedback">
                                    @error('channel_name')
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" class="form-control" id="index" name="index"
                                    placeholder="Movie Index"
                                    value="{{ old('index', isset($movie) ? $movie->index : $formated_number) }}" required>
                                <div class="invalid-feedback">
                                    @error('channel_name')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="trailer_url" id="trailer_url" class="form-control"
                                    value="{{ old('trailer', isset($movie) ? $movie->youtube_trailer : '') }}"
                            ...
                            <div class="col-md-6 mb-4" id="urldiv">
                                <label for="trailer">Movie Url*</label>
                                <input type="text" name="movie_url" id="movie_url" class="form-control"
                                    value="{{ old('trailer', isset($movie) ? $movie->movie_url : '') }}"
                                    placeholder="Movie Url" required>
                                <div class="invalid-feedback">
                                    @error('movie_url')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-md-6 mb-4" id="bkUrldiv"
                                style=" display: {{ isset($movie) && $movie->source_type != 'M3u8' ? 'none' : 'block' }}">
                                <label for="trailer">Backup Url</label>
                                <input type="text" name="bk_url" id="bk_url" class="form-control"
                                    value="{{ old('trailer', isset($movie) ? $movie->backup_url : '') }}"
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="banner" id="banner" class="form-control"
                                    ...
                                    value="{{ old('banner', isset($movie) ? $movie->banner : '') }}" required>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="movie_genre[]" id="movie_genre" multiple class="form-control select"
                                    required>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="content_network[]" id="content_networks" multiple
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <label for="fullName">Hidden Countries</label>
                                <select name="hidden_countries[]" id="hidden_countries" multiple
                                    class="form-control select">
                                    <?php
                                    foreach ($countries as $country) {
                                        if (isset($movieContries) && in_array($country->country_code, $movieContries)) {
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="status" id="status" class="form-control select">
                                    <option value="1" @if (isset($movie) && $movie->status == 1) {{ 'selected' }} @endif>
                                        Active</option>
                                    <option value="0" @if (isset($movie) && $movie->status == 0) {{ 'selected' }} @endif>
                                        De-Active</option>
                                </select>
                                <div class="invalid-feedback">
                                    @error('status')
                        ...
                        <div class="row">                
                            <div class="col-md-6 mb-4">
                                <label class="new-control new-checkbox checkbox-primary" style="user-select: none;">
                                    <input type="checkbox" name="is_recent" id="is_recent"
                                        @if (isset($movie) && $movie->is_recent == 1) {{ 'checked' }} @endif
                                        class="new-control-input">
                                    <span class="new-control-indicator" style="user-select: none"></span>Added Recent                                            
                                </label>

                                <div  id="recent_date_div" style="{{ isset($movie) && $movie->is_recent == 1 ? '' : 'display: none' }}">
                                        
                                    <label for="recent_date">Recent Date</label>
                                    <input type="date" name="recent_date" id="recent_date" class="form-control"
                                        value="{{ old('recent_date', isset($movie) ? $movie->recent_date : '') }}">
                                    <div class="invalid-feedback">
                                        @error('recent_date')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="col-md-6 mb-4">
                                <label class="new-control new-checkbox checkbox-primary" style="user-select: none;">
                                    <input type="checkbox" name="is_sd" id="is_sd"
                                        @if (isset($movie) && $movie->is_sd == 1) {{ 'checked' }} @endif
                                        class="new-control-input">
                                    <span class="new-control-indicator" style="user-select: none"></span>Mark as SD Movie                                            
                                </label>                         
                            </div>

                            <div class="col-md-12 mb-4">
                                <label for="channel_description">Movie Description</label>
                                <textarea type="text" class="form-control" id="movie_description" name="movie_description" rows="3"
                                    placeholder="Movie Description">{{ old('movie_description', isset($movie) ? $movie->description : '') }}</textarea>
                                <div class="invalid-feedback">
    ...
    <script>
        ...
        document.getElementById('is_recent').addEventListener('change', function() {
            document.getElementById('recent_date_div').style.display = this.checked ? 'block' : 'none';
        });
