                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12 mb-4">
                                <label class="new-control new-checkbox checkbox-primary">
                                  <input type="checkbox" name="is_recent" @if(isset($movie) && $movie->is_recent == 1) {{'checked'}} @endif class="new-control-input">
                                  <span class="new-control-indicator"></span>Added Recent                                  
                                </label>                                
                            </div>
