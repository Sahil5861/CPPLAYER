        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                @if(session()->has('message'))
                  ...
                  @endif
                <!-- <div class="row"> -->
                    <form id="user-form"  method="post" action="{{route('saveSlider.language')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                        @csrf
                        ...
                        <input type="hidden" name="language_id" id="language_id" value="@if(isset($slider)){{$slider->language_id}} @else{{$id}}@endif">
                        <div class="form-row">
