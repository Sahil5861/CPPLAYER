                    ...
                    <form id="user-form"  method="post" action="{{route('saveChannel')}}" enctype="multipart/form-data" novalidate class="simple-example" >
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control" id="channel_number" onkeyup="channelNumber(this.value)" name="channel_number" placeholder="Channel Number" value="{{old('channel_number')}}@if(isset($channel)){{$channel->channel_number}}@endif" @if(isset($channel)) readonly @endif required>
