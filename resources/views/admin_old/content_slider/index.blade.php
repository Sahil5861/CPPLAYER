        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="text-right">
                    <a href="{{url('add-content-network-slider/'.base64_encode($id))}}" class="btn btn-primary mb-2">Add +</a>
                </div>
...
<script>
    $(document).ready(function() { 
      var table = $('#multi-column-ordering').DataTable({ 
            ...
            "ajax": { 
                "url": "{{route('getSliderList.contentNetwork')}}",
                // "type": "POST",
                "data": function ( d ) {
                    console.log(d);
    ...
    function deleteRowModal(id){ 
        $('#d_title').text('Content Network Sliders')
        $('#d_id').val(id);
    ...
    function delete_row(){
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('slider.destroy.contentNetwork')}}",
            data: {
                _token: '{{ csrf_token() }}',
                id:id
            },
