...
<body class="form">
    ...
    <div class="form-container">
        <div class="form-form">
            <div class="form-form-wrap" style="max-width:500px;">
                <div class="form-container">
                    <div class="form-content">

                        <h1 class="">Log In to <a href="index.html"><span class="brand-name">CPPLAYER</span></a></h1>
